...
# https://github.com/huggingface/huggingface_hub/blob/776c6b798162ce240dfe2e0d3052c90ef8d3aba4/src/huggingface_hub/file_download.py
...
from huggingface_hub._local_folder import get_local_download_paths, read_download_metadata, write_download_metadata
    ...
    *,
    ...
    progress_cm: tqdm = (
        (
            ...
            else tqdm_class(  # type: ignore[assignment]
                unit="B",
                unit_scale=True,
                total=total,
                initial=resume_size,
