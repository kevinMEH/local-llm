# Modified version, original here:
# https://github.com/huggingface/huggingface_hub/blob/776c6b798162ce240dfe2e0d3052c90ef8d3aba4/src/huggingface_hub/_snapshot_download.py

import os
from pathlib import Path
from concurrent.futures import ThreadPoolExecutor
from typing import Dict, List, Literal, Optional, Type, Union, cast
...
from huggingface_hub.utils import OfflineModeIsEnabled, filter_repo_objects, logging, validate_hf_hub_args
    ...
    *,
    ...
    def _inner_hf_hub_download(repo_file: str):
        return hf_hub_download(
            ...
            token=token,
            headers=headers,
            tqdm_class=cast(Optional[Type[hf_tqdm]], inner_tqdm_class),
        )
